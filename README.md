...
1. ``src/tpHistogram.cpp``: histogram manipulation functions [related course chapter](https://perso.esiee.fr/~perretb/I5FM/TAI/histogramme/index.html) Alternative Link on Local [Traitement d’histogramme]([site/Traitement d’histogramme — Documentation Traitement et analyse d'images 1.html](https://github.com/michel-ch/image-processing/blob/main/site/Traitement%20d%E2%80%99histogramme%20%E2%80%94%20Documentation%20Traitement%20et%20analyse%20d'images%201.html))
