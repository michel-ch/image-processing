...
1. ``src/tpHistogram.cpp``: histogram manipulation functions [related course chapter](https://perso.esiee.fr/~perretb/I5FM/TAI/histogramme/index.html) Alternative Link on Local [Traitement d’histogramme](site/Traitement d’histogramme — Documentation Traitement et analyse d'images 1.html)
